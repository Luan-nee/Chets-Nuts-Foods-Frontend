...
export default function ProductEditForm(product: ProductFormData) {
  ...
  useEffect(() => {
    const venta =
      formData.precio_compra_proveedor * (1 + formData.porcentaje_ganancia);
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.porcentaje_ganancia > 10) {
      newErrors.porcentaje_ganancia =
        "El porcentaje de ganancia parece muy alto (máx 1000%)";
    }

    if (formData.precio_compra_proveedor <= 0) {
      newErrors.precio_compra_proveedor =
  ...
  return (
    <div className="max-w-3xl mx-auto my-auto bg-white rounded-xl shadow-lg p-8 border border-gray-200">
      <div className="relative grid grid-cols-2 md:grid-cols-3 gap-4 pt-12">
        ...
        {/* SKU (Solo lectura) */}
        <div className=" bg-gray-50 rounded-lg p-4 border border-gray-200 col-span-1">
        ...
        <div className="col-span-1">
          ...
          <div className="relative">
            <input
              ...
              onChange={(e) =>
                handleChange("porcentaje_ganancia", Number(e.target.value))
              }
              className={`w-full pr-4 pl-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition ${
        ...
        <div className="col-span-1">
          ...
          <input
            ...
            onChange={(e) =>
              handleChange("stock_actual", Number(e.target.value))
            }
            className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition ${
        ...
        <div className="col-span-1">
          ...
          <input
            ...
            onChange={(e) =>
              handleChange("stock_minimo", Number(e.target.value))
            }
            className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition ${
        ...
        <div className="col-span-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("precio_compra_proveedor", Number(e.target.value))
              }
        ...
        <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl shadow-lg p-8 border border-blue-200 col-span-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow">
              ...
              <p className="text-3xl font-bold text-purple-600">
                S/{(gananciaUnitaria * formData.stock_actual).toFixed(2)}
              </p>
              <p className="text-xs text-gray-500 mt-2">
          ...
          <div className="mt-6 bg-white rounded-lg p-4 border border-gray-200">
            <p className="text-sm text-gray-600">
              <span className="font-semibold">Fórmula:</span> Precio Venta =
              Precio Compra × (1 + Porcentaje Ganancia)
            </p>
            <p className="text-xs text-gray-500 mt-1">
        ...
        {/* Se muestra un mensaje indicando que hay cambios que no se guardaron */}
        {isModified && (
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 flex items-start gap-3 col-span-3">
            <AlertCircle
            ...
            <div>
              ...
              <p className="text-xs text-amber-700">
                Has modificado el producto. Recuerda guardar los cambios.
              </p>
            </div>
          </div>
        )}
