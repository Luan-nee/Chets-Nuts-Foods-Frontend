...
interface PropFormCreateProducto {
  setShowFromCreateProducto: (p: boolean) => void;
}

export default function FormCreateProducto({ setShowFromCreateProducto }: PropFormCreateProducto) {
  ...
  return (
    <div className="flex-1 h-screen flex flex-col overflow-hidden">
      ...
      <div className="bg-gray-900 border-b border-gray-800 px-8 py-6">
        <button 
          onClick={() => setShowFromCreateProducto(false)}
